...
import com.dreams.logistics.model.dto.msg.DispatchMsgDTO;
import com.dreams.logistics.model.dto.truckPlan.TruckDto;
import com.dreams.logistics.model.dto.truckPlan.TruckPlanDto;
import com.dreams.logistics.mq.TransportOrderDispatchMQListener;
...
public class DispatchJob {
    ...
    @Resource
    private TransportFeignClient truckPlanFeign;
    @Resource
    private MQFeign mqFeign;

    @Value("${dreams.volume.ratio:0.95}")
    private Double volumeRatio;
    @Value("${dreams.weight.ratio:0.95}")
