...
public interface TransportLineRepository {
     ...
     * @return 路线
     */
    TransportLineNode findShortestPath(AgencyEntity start, AgencyEntity end);
     ...
     * @return 路线
     */
    TransportLineNode findShortestPath(AgencyEntity start, AgencyEntity end, int depth);
     ...
     * @return 路线
     */
    List<TransportLineNode> findPathList(AgencyEntity start, AgencyEntity end, int depth, int limit);
