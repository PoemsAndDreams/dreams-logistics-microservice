...
public interface ScopeService {
     ...
     * @return 服务范围数据
     */
    ServiceScope queryById(String id);
     ...
     * @return 服务范围数据
     */
    ServiceScope queryByBidAndType(Long bid, ServiceTypeEnum type);
     ...
     * @return 服务范围数据
     */
    List<ServiceScope> queryListByPoint(ServiceTypeEnum type, GeoJsonPoint point);
     ...
     * @return 服务范围数据
     */
    List<ServiceScope> queryListByPoint(ServiceTypeEnum type, String address);
